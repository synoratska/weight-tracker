          ...
          datasets: [
            {
              ...
              backgroundColor: "rgba(18, 87, 104, 0.4)",
              borderColor: "#a1b9c7;",
              borderWidth: 1,
              fill: true,
            },
...
.current {
  ...
  border-radius: 50%;
  box-shadow: 0 4px 12px #555;
  border: 5px solid #125768;
...
form input[type="submit"] {
  ...
  border: none;
  cursor: pointer;
  background-color: rgb(18, 87, 104);
